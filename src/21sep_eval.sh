...
python3 test_model.py --checkpoint /home/marisa/models/22sep_OneNew_MergedSmall  --corpus eval --prefix 22sep_OneNew_MeSm

python3 test_model.py --checkpoint /home/marisa/models/22sep_OneNew_MergedSmall  --corpus tuba --prefix 22sep_OneNew_MeSm
