...
python3 finetune.py --dataset tüba --model_name  Test_NoNoCCE_OneOld_TübaSmall  --pretrained_model /home/marisa/models/Aug25Small --remove_no_cce 1

echo "Start training of MergedSmall"

python3 finetune.py --dataset merged --model_name  Test_NoNoCCE_OneOld_MergedSmall  --pretrained_model /home/marisa/models/Aug25Small --remove_no_cce 1
