...
python3 testMasking.py --checkpoint /home/marisa/models/0312MaskedSmall --prefix 0312_maskedSmall
...
python3 testMasking.py --checkpoint /home/marisa/models/0312MaskedBase --prefix 0312_maskedBase