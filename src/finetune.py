...
if __name__ == '__main__':
    ...
    if dataset_name != "":
        if dataset_name == "tüba":
            ...
            test_data = os.path.expanduser("~/data/CLEANED_ALL_OLD_tüba_test.jsonl")
        ...
        if dataset_name == "tiger":
            ...
            test_data = os.path.expanduser("~/data/CLEANED_ALL_OLD_tiger_test.jsonl")
            train_dataset = load_dataset("json", data_files=train_data, split='train')
            print("Got train data")
            test_dataset = load_dataset("json", data_files=test_data, split='train')
            print("Got test data")
        ...
        if dataset_name == "merged":
            ...
            test_data1 = os.path.expanduser("~/data/CLEANED_ALL_OLD_tiger_test.jsonl")
            train_data2 = os.path.expanduser("~/data/CLEANED_ALL_OLD_tüba_train.jsonl")
            test_data2 = os.path.expanduser("~/data/CLEANED_ALL_OLD_tüba_test.jsonl")
