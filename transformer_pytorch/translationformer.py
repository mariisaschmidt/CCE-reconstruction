# code from: https://pytorch.org/tutorials/beginner/translation_transformer.html
...
DEVICE = torch.device("cuda" if torch.cuda.is_available() else "mps") # mps for m1 mac
